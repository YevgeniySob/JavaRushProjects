...
public class Solution {
    ...
    public static class JavaDev implements SpecificSerializable {
        String answerQuestion(String question) {return String.format("I'll be thinking of [%s]", question);}
    }
    ...
    public static class JuniorJavaDev extends JavaDev {
        ...
        String askZapp(String question) {return zapp.answerQuestion(question);}
